...
// @note - similar to https://solidity-by-example.org/defi/staking-rewards/
contract Staking is IStaking, ERC20 {
    ...
    // @note - in Wenwin's setup, _rewardsToken is DAI and _stakingToken is LOT, while this is stLOT
    constructor(
        ILottery _lottery,
        ...
        // @note This ERC20 is used to track stacked amount: staking does _mint, withdrawing does _burn
        ERC20(name, symbol)
    {
