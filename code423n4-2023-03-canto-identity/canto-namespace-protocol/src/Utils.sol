...
library Utils {
    ...
    function characterToUnicodeBytes(
        ...
        if (_fontClass == 0) {
            ...
            // @note - EMOJIs are formed of at least 3 bytes
            ...
            if (_characterModifier != 0) {
                ...
                // @note -  F09F8FBB - F09F8FBF represent skin tones modifiers
            ...
            for (uint256 i; i < numAbove; ++i) {
                _characterModifier = iteratePRNG(_characterModifier);
                // @note - each character is two bytes, that's why it is multiplied by 2
