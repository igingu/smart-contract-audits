...
// @note most base class representing a Random Number Source
// @note has requestRandomNumber method (the method that initiates the Oracle flow)
interface IRNSource {
...
// @note most base class representing a Random Number Consumer
// @note has onRandomNumberFulfilled method (the method that represents the callback, in the Oracle flow)
