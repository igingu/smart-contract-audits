...
library TicketUtils {
    ...
    // @note - asked myself the question if this ticket reconstruction turns uniformly distributed random numbers
    //         into uniformy distributed random tickets
    //         couldn't figure out logic in my head, but ran a NodeJS script trying to see probabilities,
    //         and they ended up being the same, which I guess would make it uniformly distributed
        ...
        returns (uint8 winTier)
    {
        unchecked {
            ...
            // @note winTier should never be bigger than amount of numbers selected
            // @note intersection should never contain bits of 1 on positions bigger than selectionMax
