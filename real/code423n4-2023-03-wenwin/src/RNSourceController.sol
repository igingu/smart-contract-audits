...
abstract contract RNSourceController is Ownable2Step, IRNSourceController {
    ...
    // @note - This initializes Lottery's state, with the address of the VRFv2RNSource contract
    ...
    // @note - Swaps the address RNSource, to something else if needed
    // @note - Only callable by owners, in certain conditions
    ...
    // @audit-issue Malicious owner can block user funds by switching Oracle implementation to dummy one, which always
    // returns some number and always fulfills requests
