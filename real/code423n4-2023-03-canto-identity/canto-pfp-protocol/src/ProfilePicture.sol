...
contract ProfilePicture is ERC721 {
    ...
    constructor(address _cidNFT, string memory _subprotocolName) ERC721("Profile Picture", "PFP") {
        ...
        // @note - chainId of Canto blockchain
        // @note - Registers the contract with the Canto CSR Registry, 
        //         so that it receives fees whenever users interact with it
    ...
    function getPFP(uint256 _pfpID) public view returns (address nftContract, uint256 nftID) {
        ...
        // @note - is only valid if it is linked to a CIDNFTId
        //         and the registered address for that cidNFTId is the owner of the profile picture NFT
