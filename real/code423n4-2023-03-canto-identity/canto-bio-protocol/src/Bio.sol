...
mapping(uint256 => string) public bio;
    ...
    function tokenURI(uint256 _id) public view override returns (string memory) {
        ...
        // @note - number of newlines to insert => for 41, need 2 newlines, for 40, need 1 newline
        ...
        for (uint i; i < lengthInBytes; ++i) {
            ...
            // if am at last character before newline should come
            ...
            if ((i + 1) % 40 == 0 || prevByteWasContinuation || i == lengthInBytes - 1) {
                ...
                if (nextCharacter & 0xC0 == 0x80) {
                    ...
                    if (
                        ...
                        // Note - check if current character is ending of Zero Width Joiner 
                        //         https://emojipedia.org/zero-width-joiner/#:~:text=Zero%20Width%20Joiner%20(ZWJ)%20is,invisible%20character%20when%20used%20alone.
                        (i >= 2 &&
